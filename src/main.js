        ...
        <div class="footer-content">
          <div class="footer-cta">
            ...
            <form class="contact-form" id="contactForm">
              ...
              <div class="form-group">
                <textarea name="message" placeholder="Tell us about your project *" required class="form-input form-textarea" rows="4"></textarea>
              </div>
              <button type="submit" class="btn-cta-gradient" id="contactSubmitBtn">Send Message</button>
          ...
          <div class="footer-info">
            ...
            <div class="footer-info-block">
              <h4 class="footer-info-label">Email</h4>
              <a href="mailto:hello@skypark.id" class="footer-info-text footer-link footer-icon-link">
                <svg class="footer-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                hello@skypark.id
              </a>
            </div>
          </div>
